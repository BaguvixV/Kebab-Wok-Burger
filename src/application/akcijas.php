...
<body>
      ...
      <section>
         <div class="aside-section-2">
            ...
            <form action="#" class="form" method="post" name="form-submit" onsubmit="return validateForm()">
               ...
               <div class="form-group">
                  <label>Adrese:</label>
                  <input type="text" name="city" placeholder="Pilsēta, adresse uz kuru sūtīt pasūtījumu ..." />
               </div>
               <div class="form-group">
   ...
   <main>
      ...
      <?php
         ...
         $stmt = $db_conn->prepare("SELECT * FROM `produkti` WHERE `produkti`.`kategorija_id` = 'akcija'");
         $stmt->execute();
